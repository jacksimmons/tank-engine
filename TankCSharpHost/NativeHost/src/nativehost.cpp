...
namespace
{
    ...
    /// <summary>
    /// Initialises host context, prepares for init of .NET runtime using
	/// specific config.
    /// </summary>
    hostfxr_initialize_for_runtime_config_fn init_for_config_fptr;
    /// <summary>
	/// Gets a C# delegate for use at runtime.
    /// </summary>
...
namespace
{
    ...
    load_assembly_and_get_function_pointer_fn get_dotnet_load_assembly(const char_t *config_path)
    {
        ...
        hostfxr_handle cxt = nullptr;
        int code = init_for_config_fptr(config_path, nullptr, &cxt);
        if (code != 0 || cxt == nullptr)
        {
        ...
        code = get_delegate_fptr(
            cxt,
            hdt_load_assembly_and_get_function_pointer,
            &load_assembly_and_get_function_pointer);
        if (code != 0 || load_assembly_and_get_function_pointer == nullptr)
